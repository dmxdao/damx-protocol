...
async function main() {
  ...
  const addresses = {
    ...
    VAULT_PRICE_FEED: vaultPriceFeed.address,
    GLP: glp.address,
    SHORTS_TRACKER: shortsTracker.address,
    GLP_MANAGER: glpManager.address,
    VAULT_ERROR_CONTROLLER: vaultErrorController.address,
    VAULT_UTILS: vaultUtils.address
  }
