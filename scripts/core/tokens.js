...
module.exports = {
  ...
  ftmTestnet: {
    btc: {
      name: "btc",
      address: "0xED526e6e178145CeD8E8fE9Fd660FF75B9D110DA",
      decimals: 8,
    ...
    eth: {
      name: "eth",
      address: "0xCf3b929028eB7aC186600E721b97925e69BD8ef9",
      decimals: 18,
    ...
    wftm: {
      name: "wftm",
      address: "0xA4d6CA27461435EEF00aFBc0B736f1df7EcF0b4e",
      decimals: 18,
    ...
    link: {
      name: "link",
      address: "0xC29241355C1E7857656F156400Fe3E68773557Cf",
      decimals: 18,
    ...
    usdt: {
      name: "usdt",
      address: "0x1EbB76944cea70b6F284B0399b9A721F51a64d89",
      decimals: 6,
  ...
  opera: {
    btc: {
      ...
      tokenWeight: 19000,
      minProfitBps: 0,
      maxUsdgAmount: 3.8 * 1000 *1000,
      bufferAmount: 56,
      isStable: false,
      isShortable: true,
      maxGlobalLongSize: 2.137 * 1000 * 1000,
    ...
    wftm: {
      ...
      tokenWeight: 13000,
      minProfitBps: 0,
      maxUsdgAmount: 2.6 * 1000 * 1000,
      bufferAmount: 1.5 * 1000 * 1000,
      isStable: false,
      isShortable: true,
      maxGlobalLongSize: 1.462 * 1000 * 1000,
      maxGlobalShortSize: 0.78 * 1000 * 1000
    },
    usdc: {
      name: "usdc",
    ...
    dai: {
      ...
      tokenWeight: 4000,
      minProfitBps: 0,
      maxUsdgAmount: 0.8 * 1000 * 1000,
      bufferAmount: 0.28 * 1000 * 1000,
      isStable: true,
      isShortable: false
    },
    nativeToken: {
